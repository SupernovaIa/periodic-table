...
const MOLECULE_CATEGORIES = {
  ...
  "bio":       { en: "Biomolecules & drugs", es: "Biomoléculas y fármacos" }
};
...
const MOLECULE_UI = {
  en: {
    ...
    labels: {
      ...
      bonds: "Bonds", geom: "Shape", type: "Type"
    }
  },
  es: {
    molecules: "Moléculas",
    ...
    labels: {
      ...
      bonds: "Enlaces", geom: "Geometría", type: "Tipo"
    }
  }
};

const MOLECULES = [
  {id:"water",s:"H<sub>2</sub>O",name:{en:"Water",es:"Agua"},cat:"inorganic",mass:18.02,
  ...
  {id:"co2",s:"CO<sub>2</sub>",name:{en:"Carbon dioxide",es:"Dióxido de carbono"},cat:"inorganic",mass:44.01,
  ...
  {id:"methane",s:"CH<sub>4</sub>",name:{en:"Methane",es:"Metano"},cat:"organic",mass:16.04,
  ...
  {id:"ethanol",s:"C<sub>2</sub>H<sub>5</sub>OH",name:{en:"Ethanol",es:"Etanol"},cat:"organic",mass:46.07,
  ...
  {id:"benzene",s:"C<sub>6</sub>H<sub>6</sub>",name:{en:"Benzene",es:"Benceno"},cat:"organic",mass:78.11,
  ...
  {id:"aspirin",s:"C<sub>9</sub>H<sub>8</sub>O<sub>4</sub>",name:{en:"Aspirin",es:"Aspirina"},cat:"bio",mass:180.16,
  ...
  {id:"caffeine",s:"C<sub>8</sub>H<sub>10</sub>N<sub>4</sub>O<sub>2</sub>",name:{en:"Caffeine",es:"Cafeína"},cat:"bio",mass:194.19,
